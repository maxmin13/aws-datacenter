...
JUMPBOX_WORKDIR_DIR="${PROJECT_DIR}"/cf/jumpbox
JUMPBOX_ACCESS_DIR="${PROJECT_DIR}"/access/jumpbox
BOSH_WORKDIR_DIR="${PROJECT_DIR}"/cf/bosh
BOSH_ACCESS_DIR="${PROJECT_DIR}"/access/bosh
