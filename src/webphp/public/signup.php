	...
	<form name="signupform" id="signupform" action="signup2.php" method="post" enctype="application/x-www-form-urlencoded">
		...
		<tr>
			...
			<td align="left" valign="middle">
				<input type="Text" name="emailsu" id="emailsu" value="" maxlength="255" onchange="$('#msg3').html('');">
			</td>
			<td align="left">&nbsp;</td>
		</tr>
		<tr>
			...
			<td align="left" valign="middle">
				<input type="Text" name="emailsu2" id="emailsu2" value="" maxlength="255" onchange="$('#msg3').html('');">
			</td>
			<td></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td align="left">
				<input type="Password" name="passwordsu" id="passwordsu" maxlength="32" onchange="$('#msg2').html('');">
			</td>
		...
		<tr>
			...
			<td colspan="2" align="left">
				<input type="Password" name="passwordsu2" id="passwordsu2" maxlength="32" onchange="$('#msg2').html('');">
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		...
		<tr>
			...
			<td align="left" valign="middle">
				<input type="Text" name="usernamesu" id="usernamesu" value="" maxlength="16" onchange="$('#msg').html('');">
			</td>
			<td>
		...
		<tr>
			...
			<td colspan='2' align="left">
				<input type="checkbox" id="terms" name="terms" value="1"> I accept the <a href="/public/terms.php" target="external">Terms and Conditions</a>
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		...
		<tr>
			<td colspan='3' align="center"><br>
				<input type="button" value="SIGN UP NOW" onclick="check_submit();">
			</td>
		</tr>
