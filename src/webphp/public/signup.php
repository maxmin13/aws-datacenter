...
<script
	...
	src="https://www.google.com/recaptcha/a../recaptcha_ajax.js"></script>
...
<table width="500">
	<form name="signupform" id="signupform" action="signup2.php"
		...
		<tr>
			<td>&nbsp;</td>
			<td colspan='2'><div id="msg3" class="errmessage">
			<?php echo $message3;?>
				</div></td>
		</tr>
		<tr>
		...
		<tr>
			<td>&nbsp;</td>
			<td colspan='2'><div id="msg2" class="errmessage">
			<?php echo $message2;?>
				</div></td>
		</tr>
		<tr>
			...
			<td><input type="button" name="button_su1" value="CHECK"
				onclick="do_check_signup(0);">
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td colspan='2'><div id="msg" class="errmessage">
			<?php echo $message1;?>
				</div></td>
		</tr>
		...
		<tr>
			...
			<td colspan='2'>
				<div id="recaptchadiv"></div> <input type="hidden" name="rcc"
				id="rcc" value=""> <input type="hidden" name="rcr" id="rcr" value="">
				<input type="hidden" name="rch" id="rch" value="">
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td colspan='2'><div id="msgrc" class="errmessage">
			<?php echo $messagerc;?>
				</div></td>
		</tr>
		<tr>
