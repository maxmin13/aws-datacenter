...
function sessionstart($nuserID)
{
    ...
    doSQL("update users set sessiontoken1=?, sessiontoken2=?, sessionipaddress=?, sessionuseragent=?, sessionlastdateSQL=now() where userID=?;", $sessiontoken1, $sessiontoken2, $ipaddress, $useragent, $nuserID) or die("ERR");
}
...
function sessionsave($S)
{
    ...
    doSQL("update users set email=? where userID=?;", $S['email'], $S['userID']) or die("ERR");
}
...
function sessionend($nuserID)
{
    ...
    doSQL("update users set sessiontoken1='', sessiontoken2='', sessionipaddress='', sessionuseragent='', sessionlastdateSQL=now() where userID=?;", $nuserID) or die("ERR");
